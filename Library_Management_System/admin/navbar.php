				...
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
							<div class="container-fluid">
										...
										?>
													...
													<li class="nav-item"><a class="nav-link" href="student.php"><span>STUDENT-INFORMATION</span></a></li>	
										...
										?>
													<li class="nav-item"><a class="nav-link" href="admin_login.php"><span> LOGIN</span></a></li>
										<?php
											    }
										?>
